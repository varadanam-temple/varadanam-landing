export const temples = [
  {
    ...
    quickFacts: [
      ...
      { label: 'Devaswom', value: 'Guruvayur Devaswom' },
      { label: 'Daily Poojas', value: '8 poojas per day' },
      { label: 'Entry', value: 'Hindus only' },
      { label: 'Famous For', value: 'Guruvayur Ekadasi, Weddings, Gajamela' },
    ],
    sections: [
      {
        heading: 'Origin — The Divine Installation',
        body: `Guruvayur Sree Krishna Temple carries one of the most captivating origin legends in Hindu tradition. The sacred idol — depicting Vishnu in his four-armed form — is believed to be the same one that Lord Brahma himself worshipped at the beginning of creation. It was later given to the sage Kashyapa and his wife Aditi, and then passed on to Vasudeva, the father of Lord Krishna, who worshipped it throughout Krishna's life in Dwaraka.
...
Devotees who receive the darshan of Guruvayurappan say that the idol appears different each time — at times like the infant Krishna, at times like the youthful Krishna of Vrindavan, and at times like Mahavishnu in all his cosmic splendour.`,
      ...
      {
        heading: 'History Through the Centuries',
        body: `The Guruvayur temple does not have a single founding date — its roots are woven into mythology, and its documented history spans over seven centuries of recorded events.
...
The temple complex has four entrance towers (gopurams) — one on each side — though the eastern gopuram is the primary entrance. The Kizhakke Gopuram (eastern) is the main gateway and is where devotees queue for darshan.`,
      ...
      {
        heading: 'Daily Poojas — The Eternal Rhythm',
        body: `Guruvayur follows one of the most rigorous and ancient pooja schedules of any temple in India — eight poojas per day, conducted without interruption since the temple's restoration, following the Vaikhanasa Agama tradition.
...
The final pooja of the day — conducted after the temple has closed to the public. The Lord is put to rest (Thiruvanandal Seeveli).`,
      ...
      {
        heading: 'Festivals — The Grand Calendar',
        body: `**Guruvayur Ekadasi**
...
Kesavan's legacy has inspired generations of devotees. Many subsequent notable temple elephants — including Gajarajan Padmanabhan and others — have served in his tradition, but none have quite captured the popular imagination as he did.`,
      ...
      {
        heading: 'Narayaneeyam — The Living Scripture',
        body: `The Narayaneeyam, composed by Melpathur Narayana Bhattathiri between 1586 and 1587 at Guruvayur, remains one of the greatest devotional works in Sanskrit literature. Its 1,036 verses across 100 cantos are a compression of the entire Bhagavata Purana into a single, singable devotional poem — each canto ending with the refrain "Vatalay Vaasa" addressed to the Lord of Guruvayur.
...
Every day, devotees receive a copy of the Narayaneeyam as prasadam at the temple — a practice that has made it one of the most widely circulated Sanskrit works in South India.`,
      ...
      {
        heading: 'Guruvayur Weddings — The Most Auspicious Union',
        body: `Guruvayur holds a special place in Kerala's cultural and social life as the most sought-after wedding venue in the state. A wedding conducted in the presence of Guruvayurappan is believed to be blessed by Lord Vishnu himself — the divine witness to the union.
